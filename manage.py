#imports libraries that are required 
...
#imports modules for both the users and the products 
from app.models.users import Users
from app.models.products import Products

#imports modules that are required for the website; customer, supplier, etc
...
#creates a new flask group to allow/establish different usernames; name, email, password, contact
...
#creats a new flask for products; name, image, rating, etc
product_json = [
	{
...
#creating a function that allows for data tables to be created with specific rows and columns 
def seeder():
